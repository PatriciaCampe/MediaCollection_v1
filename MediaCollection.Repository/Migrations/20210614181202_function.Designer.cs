...
namespace MediaCollection.Repository.Migrations
{
    ...
    [Migration("20210614181202_function")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MediaCollection.Domain.MediaFunction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MediaCollection.Domain.Person", b =>
                {
                    ...
                    b.Property<int?>("MediaFunctionId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("MediaFunctionId");
            ...
            modelBuilder.Entity("MediaCollection.Domain.MediaFunction", b =>
                {
                    ...
                    b.HasOne("MediaCollection.Domain.Music", null)
                        .WithMany("MusicFunctions")
                        .HasForeignKey("MusicId");

                    b.HasOne("MediaCollection.Domain.Podcast", null)
                        .WithMany("PodcastFunctions")
                        .HasForeignKey("PodcastId");

                    b.HasOne("MediaCollection.Domain.Serie", null)
                        .WithMany("SerieFunctions")
                        .HasForeignKey("SerieId");
            ...
            modelBuilder.Entity("MediaCollection.Domain.Person", b =>
                {
                    b.HasOne("MediaCollection.Domain.MediaFunction", "MediaFunction")
                        .WithMany("Persons")
                        .HasForeignKey("MediaFunctionId");

                    b.Navigation("MediaFunction");
                });
            ...
            modelBuilder.Entity("MediaCollection.Domain.Music", b =>
                {
                    b.Navigation("MusicFunctions");
                });

            modelBuilder.Entity("MediaCollection.Domain.Podcast", b =>
                {
                    b.Navigation("PodcastFunctions");
                });
