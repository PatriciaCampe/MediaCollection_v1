...
namespace MediaCollection.Repository.Migrations
{
    ...
    [Migration("20210622100613_mediagenre")]
    partial class mediagenre
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MediaCollection.Domain.MediaGenre", b =>
                {
                    b.Property<int>("MediaId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MediaCollection.Domain.Genre", b =>
                {
                    b.HasOne("MediaCollection.Domain.Media", null)
                        .WithMany("Genres")
            ...
            modelBuilder.Entity("MediaCollection.Domain.MediaGenre", b =>
                {
                    b.HasOne("MediaCollection.Domain.Genre", "Genre")
                        .WithMany("MediaGenre")
